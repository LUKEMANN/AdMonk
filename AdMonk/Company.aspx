<%@ Page Title="" Language="C#" MasterPageFile="~/AdminView.master" AutoEventWireup="true" CodeFile="Company.aspx.cs" Inherits="Company" %>
     ...
     <div class="form-group">
        ...
        <div class="form-group">
            <div class="col-sm-offset-6 col-sm-3">
                ...
                <asp:SqlDataSource ID="SqlDataSourceCompany" runat="server" ConnectionString="<%$ ConnectionStrings:connect %>" DeleteCommand="DELETE FROM [Company] WHERE [Company_Id] = @Company_Id" InsertCommand="INSERT INTO [Company] ([Contact], [Email], [Name]) VALUES (@Contact, @Email, @Name)" SelectCommand="SELECT [Company_Id], [Contact], [Email], [Name] FROM [Company]" UpdateCommand="UPDATE [Company] SET [Contact] = @Contact, [Email] = @Email, [Name] = @Name WHERE [Company_Id] = @Company_Id">
                    <DeleteParameters>
